...
| ADR | Decision | Status |
|---|---|---|
| [0001](ADR-0001-board-projection.md) | Board projection is normative; Decay and deferral are presentation, not chain steps | Provisional — needs a MECHANICS.md ruling on §13 I-02 |
...
| [0005](ADR-0005-refund-floor-carry.md) | Refunds the floor cannot grant yet are carried within the word | Provisional — needs a ruling on §13 I-16 |
| [0006](ADR-0006-new-spec-problems.md) | Six engineering problems found while building Phase 1 (§13 I-15 … I-20) | Raised, unresolved |
